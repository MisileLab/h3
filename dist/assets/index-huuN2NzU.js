...
`;C.select`
  ...
  font-size: 20px;
`;const Tt="/assets/PARA-z7PUJ0NC.svg",St=L("<br>"),$t=C.div`
  width: 100%;
  height: 110vh;
  background: #ffffff;
  display: flex;
...
`,Lt=()=>{let e=!1,t=0,n=0,i=0,r=0,u=0;const o=new Date("2023-12-18T18:00:00"),l=new Date("2023-12-24T23:59:59"),c=()=>{window.open("https://www.instagram.com/sunrin_para/","_blank","noreferrer")},d=()=>{e&&window.open("https://forms.gle/cVMum1hGpMB3gNPf6","_blank","noreferrer")};let f=setInterval(()=>{let h=new Date,B=document.getElementById("Period");if(B==null)return;let w="";o.getFullYear()!==h.getFullYear()||l.getDate()<h.getDate()?(w="지원 기간이 아닙니다.",clearInterval(f)):(t=o.getTime()-h.getTime(),n=Math.floor(t/(1e3*60*60*24)),i=Math.floor(t%(1e3*60*60*24)/(1e3*60*60)),r=Math.floor(t%(1e3*60*60)/(1e3*60)),u=Math.floor(t%(1e3*60)/1e3),t<0?(e=!0,t=l.getTime()-h.getTime(),n=Math.floor(t/(1e3*60*60*24)),i=Math.floor(t%(1e3*60*60*24)/(1e3*60*60)),r=Math.floor(t%(1e3*60*60)/(1e3*60)),u=Math.floor(t%(1e3*60)/1e3),w=w=`지원 기간 : 12월 18일 18시 ~ 12월 24일<br>
                지원 마감까지 남은 시간 : ${n}일 ${i}시간 ${r}분 ${u}초`):w=`지원 기간 : 12월 18일 18시 ~ 12월 24일<br>
                지원 시작까지 남은 시간 : ${n}일 ${i}시간 ${r}분 ${u}초`),B.innerHTML=w},1e3);return s($t,{get children(){return[s(Ft,{children:" 지원 안내 및 문의 "}),s(Pt,{id:"Period",children:" 지원 기간 : 추후 공개 예정"}),s(kt,{get children(){return[s(de,{get children(){return[s(Ot,{}),s(J,{children:"동아리 문의 연락처"}),s(Y,{get children(){return["Insta : @sunrin_para",St(),"facebook : 미개설"]}})]}}),s($e,{}),s(de,{get children(){return[s(J,{children:"부장 이정훈"}),s(Y,{children:"Insta : @compy07"}),s(J,{style:{"margin-top":"30px"},children:"쀼장 유채호"}),s(Y,{children:"Insta : @chaeho_yu_   |   Tell : 01087343741"}),s(jt,{})]}})]}}),s(Nt,{onClick:c,style:{"margin-top":"40px"},get children(){return s(he,{style:{color:"black"},children:"인스타그램으로 문의"})}}),s(zt,{onClick:d,get children(){return s(he,{children:"PARA 지원하기"})}})]}})},F=L("<br>"),Mt=C.div`
  width: 100%;
  height: 100vh;
  background: #ffffff;
  display: flex;
...
`,qt=C.div`
  ...
  height: 100%;
  gap: 7px;
`,Jt=()=>s(Vt,{get children(){return s(Wt,{get children(){return s(qt,{get children(){return[s(Kt,{children:"P  A  R  A"}),s(Xt,{children:"Project Achievement & Research AI"})]}})}})}}),Yt=C.header`
  position: fixed;
  top: ${e=>e?"0":"-200px"};
