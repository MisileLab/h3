var ht=Object.defineProperty;var gt=(L,z,R)=>z in L?ht(L,z,{enumerable:!0,configurable:!0,writable:!0,value:R}):L[z]=R;var tt=(L,z,R)=>gt(L,typeof z!="symbol"?z+"":z,R);import{g as mt,c as ft}from"./_commonjsHelpers.Cpj98o6Y.js";var et={exports:{}};(function(L,z){(function(R,S){L.exports=S()})(ft,function(){function R(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let S={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const Z=/[&<>"']/,nt=new RegExp(Z.source,"g"),j=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,st=new RegExp(j.source,"g"),it={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},H=h=>it[h];function b(h,n){if(n){if(Z.test(h))return h.replace(nt,H)}else if(j.test(h))return h.replace(st,H);return h}const rt=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function B(h){return h.replace(rt,(n,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):"")}const at=/(^|[^\[])\^/g;function k(h,n){h=typeof h=="string"?h:h.source,n=n||"";const t={replace:(e,s)=>(s=(s=s.source||s).replace(at,"$1"),h=h.replace(e,s),t),getRegex:()=>new RegExp(h,n)};return t}const ot=/[^\w:]/g,lt=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function J(h,n,t){if(h){let e;try{e=decodeURIComponent(B(t)).replace(ot,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}n&&!lt.test(t)&&(t=function(e,s){P[" "+e]||(ct.test(e)?P[" "+e]=e+"/":P[" "+e]=O(e,"/",!0)),e=P[" "+e];const a=e.indexOf(":")===-1;return s.substring(0,2)==="//"?a?s:e.replace(pt,"$1")+s:s.charAt(0)==="/"?a?s:e.replace(ut,"$1")+s:e+s}(n,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const P={},ct=/^[^:]+:\/*[^/]*$/,pt=/^([^:]+:)[\s\S]*$/,ut=/^([^:]+:\/*[^/]*)[\s\S]*$/,q={exec:function(){}};function Q(h,n){const t=h.replace(/\|/g,(s,a,r)=>{let i=!1,o=a;for(;--o>=0&&r[o]==="\\";)i=!i;return i?"|":" |"}).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function O(h,n,t){const e=h.length;if(e===0)return"";let s=0;for(;s<e;){const a=h.charAt(e-s-1);if(a!==n||t){if(a===n||!t)break;s++}else s++}return h.slice(0,e-s)}function W(h,n){if(n<1)return"";let t="";for(;n>1;)1&n&&(t+=h),n>>=1,h+=h;return t+h}function K(h,n,t,e){const s=n.href,a=n.title?b(n.title):null,r=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){e.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:e.inlineTokens(r)};return e.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:b(r)}}class D{constructor(n){this.options=n||S}space(n){const t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){const t=this.rules.block.code.exec(n);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:O(e,`
...
`)}(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:s}}}heading(n){const t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(/#$/.test(e)){const s=O(e,"#");this.options.pedantic?e=s.trim():s&&!/ $/.test(s)||(e=s.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){const t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){const t=this.rules.block.blockquote.exec(n);if(t){const e=t[0].replace(/^ *>[ \t]?/gm,""),s=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(e);return this.lexer.state.top=s,{type:"blockquote",raw:t[0],tokens:a,text:e}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e,s,a,r,i,o,c,d,l,p,w,T,y=t[1].trim();const _=y.length>1,f={type:"list",raw:"",ordered:_,start:_?+y.slice(0,-1):"",loose:!1,items:[]};y=_?`\\d{1,9}\\${y.slice(-1)}`:`\\${y}`,this.options.pedantic&&(y=_?y:"[*+-]");const I=new RegExp(`^( {0,3}${y})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;n&&(T=!1,t=I.exec(n))&&!this.rules.block.hr.test(n);){if(e=t[0],n=n.substring(e.length),d=t[2].split(`
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(n){return`<del>${n}</del>`}link(n,t,e){if((n=J(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s='<a href="'+n+'"';return t&&(s+=' title="'+t+'"'),s+=">"+e+"</a>",s}image(n,t,e){if((n=J(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s=`<img src="${n}" alt="${e}"`;return t&&(s+=` title="${t}"`),s+=this.options.xhtml?"/>":">",s}text(n){return n}}class F{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,t,e){return""+e}image(n,t,e){return""+e}br(){return""}}class Y{constructor(){this.seen={}}serialize(n){return n.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(n,t){let e=n,s=0;if(this.seen.hasOwnProperty(e)){s=this.seen[n];do s++,e=n+"-"+s;while(this.seen.hasOwnProperty(e))}return t||(this.seen[n]=s,this.seen[e]=0),e}slug(n,t={}){const e=this.serialize(n);return this.getNextSafeSlug(e,t.dryrun)}}class E{constructor(n){this.options=n||S,this.options.renderer=this.options.renderer||new U,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new F,this.slugger=new Y}static parse(n,t){return new E(t).parse(n)}static parseInline(n,t){return new E(t).parseInline(n)}parse(n,t=!0){let e,s,a,r,i,o,c,d,l,p,w,T,y,_,f,I,M,v,A,x="";const C=n.length;for(e=0;e<C;e++)if(p=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[p.type]&&(A=this.options.extensions.renderers[p.type].call({parser:this},p),A!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(p.type)))x+=A||"";else switch(p.type){case"space":continue;case"hr":x+=this.renderer.hr();continue;case"heading":x+=this.renderer.heading(this.parseInline(p.tokens),p.depth,B(this.parseInline(p.tokens,this.textRenderer)),this.slugger);continue;case"code":x+=this.renderer.code(p.text,p.lang,p.escaped);continue;case"table":for(d="",c="",r=p.header.length,s=0;s<r;s++)c+=this.renderer.tablecell(this.parseInline(p.header[s].tokens),{header:!0,align:p.align[s]});for(d+=this.renderer.tablerow(c),l="",r=p.rows.length,s=0;s<r;s++){for(o=p.rows[s],c="",i=o.length,a=0;a<i;a++)c+=this.renderer.tablecell(this.parseInline(o[a].tokens),{header:!1,align:p.align[a]});l+=this.renderer.tablerow(c)}x+=this.renderer.table(d,l);continue;case"blockquote":l=this.parse(p.tokens),x+=this.renderer.blockquote(l);continue;case"list":for(w=p.ordered,T=p.start,y=p.loose,r=p.items.length,l="",s=0;s<r;s++)f=p.items[s],I=f.checked,M=f.task,_="",f.task&&(v=this.renderer.checkbox(I),y?f.tokens.length>0&&f.tokens[0].type==="paragraph"?(f.tokens[0].text=v+" "+f.tokens[0].text,f.tokens[0].tokens&&f.tokens[0].tokens.length>0&&f.tokens[0].tokens[0].type==="text"&&(f.tokens[0].tokens[0].text=v+" "+f.tokens[0].tokens[0].text)):f.tokens.unshift({type:"text",text:v}):_+=v),_+=this.parse(f.tokens,y),l+=this.renderer.listitem(_,M,I);x+=this.renderer.list(l,w,T);continue;case"html":x+=this.renderer.html(p.text);continue;case"paragraph":x+=this.renderer.paragraph(this.parseInline(p.tokens));continue;case"text":for(l=p.tokens?this.parseInline(p.tokens):p.text;e+1<C&&n[e+1].type==="text";)p=n[++e],l+=`
`+(p.tokens?this.parseInline(p.tokens):p.text);x+=t?this.renderer.paragraph(l):l;continue;default:{const G='Token with "'+p.type+'" type was not found.';if(this.options.silent)return void console.error(G);throw new Error(G)}}return x}parseInline(n,t){t=t||this.renderer;let e,s,a,r="";const i=n.length;for(e=0;e<i;e++)if(s=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[s.type]&&(a=this.options.extensions.renderers[s.type].call({parser:this},s),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)))r+=a||"";else switch(s.type){case"escape":case"text":r+=t.text(s.text);break;case"html":r+=t.html(s.text);break;case"link":r+=t.link(s.href,s.title,this.parseInline(s.tokens,t));break;case"image":r+=t.image(s.href,s.title,s.text);break;case"strong":r+=t.strong(this.parseInline(s.tokens,t));break;case"em":r+=t.em(this.parseInline(s.tokens,t));break;case"codespan":r+=t.codespan(s.text);break;case"br":r+=t.br();break;case"del":r+=t.del(this.parseInline(s.tokens,t));break;default:{const o='Token with "'+s.type+'" type was not found.';if(this.options.silent)return void console.error(o);throw new Error(o)}}return r}}class N{constructor(n){this.options=n||S}preprocess(n){return n}postprocess(n){return n}}tt(N,"passThroughHooks",new Set(["preprocess","postprocess"]));function X(h,n){return(t,e,s)=>{typeof e=="function"&&(s=e,e=null);const a={...e},r=function(i,o,c){return d=>{if(d.message+=`
Please report this to https://github.com/markedjs/marked.`,i){const l="<p>An error occurred:</p><pre>"+b(d.message+"",!0)+"</pre>";return o?Promise.resolve(l):c?void c(null,l):l}if(o)return Promise.reject(d);if(!c)throw d;c(d)}}((e={...g.defaults,...a}).silent,e.async,s);if(t==null)return r(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return r(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(function(i){i&&i.sanitize&&!i.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(e),e.hooks&&(e.hooks.options=e),s){const i=e.highlight;let o;try{e.hooks&&(t=e.hooks.preprocess(t)),o=h(t,e)}catch(l){return r(l)}const c=function(l){let p;if(!l)try{e.walkTokens&&g.walkTokens(o,e.walkTokens),p=n(o,e),e.hooks&&(p=e.hooks.postprocess(p))}catch(w){l=w}return e.highlight=i,l?r(l):s(null,p)};if(!i||i.length<3||(delete e.highlight,!o.length))return c();let d=0;return g.walkTokens(o,function(l){l.type==="code"&&(d++,setTimeout(()=>{i(l.text,l.lang,function(p,w){if(p)return c(p);w!=null&&w!==l.text&&(l.text=w,l.escaped=!0),d--,d===0&&c()})},0))}),void(d===0&&c())}if(e.async)return Promise.resolve(e.hooks?e.hooks.preprocess(t):t).then(i=>h(i,e)).then(i=>e.walkTokens?Promise.all(g.walkTokens(i,e.walkTokens)).then(()=>i):i).then(i=>n(i,e)).then(i=>e.hooks?e.hooks.postprocess(i):i).catch(r);try{e.hooks&&(t=e.hooks.preprocess(t));const i=h(t,e);e.walkTokens&&g.walkTokens(i,e.walkTokens);let o=n(i,e);return e.hooks&&(o=e.hooks.postprocess(o)),o}catch(i){return r(i)}}}function g(h,n,t){return X($.lex,E.parse)(h,n,t)}return g.options=g.setOptions=function(h){var n;return g.defaults={...g.defaults,...h},n=g.defaults,S=n,g},g.getDefaults=R,g.defaults=S,g.use=function(...h){const n=g.defaults.extensions||{renderers:{},childTokens:{}};h.forEach(t=>{const e={...t};if(e.async=g.defaults.async||e.async||!1,t.extensions&&(t.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if(s.renderer){const a=n.renderers[s.name];n.renderers[s.name]=a?function(...r){let i=s.renderer.apply(this,r);return i===!1&&(i=a.apply(this,r)),i}:s.renderer}if(s.tokenizer){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");n[s.level]?n[s.level].unshift(s.tokenizer):n[s.level]=[s.tokenizer],s.start&&(s.level==="block"?n.startBlock?n.startBlock.push(s.start):n.startBlock=[s.start]:s.level==="inline"&&(n.startInline?n.startInline.push(s.start):n.startInline=[s.start]))}s.childTokens&&(n.childTokens[s.name]=s.childTokens)}),e.extensions=n),t.renderer){const s=g.defaults.renderer||new U;for(const a in t.renderer){const r=s[a];s[a]=(...i)=>{let o=t.renderer[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.renderer=s}if(t.tokenizer){const s=g.defaults.tokenizer||new D;for(const a in t.tokenizer){const r=s[a];s[a]=(...i)=>{let o=t.tokenizer[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.tokenizer=s}if(t.hooks){const s=g.defaults.hooks||new N;for(const a in t.hooks){const r=s[a];N.passThroughHooks.has(a)?s[a]=i=>{if(g.defaults.async)return Promise.resolve(t.hooks[a].call(s,i)).then(c=>r.call(s,c));const o=t.hooks[a].call(s,i);return r.call(s,o)}:s[a]=(...i)=>{let o=t.hooks[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.hooks=s}if(t.walkTokens){const s=g.defaults.walkTokens;e.walkTokens=function(a){let r=[];return r.push(t.walkTokens.call(this,a)),s&&(r=r.concat(s.call(this,a))),r}}g.setOptions(e)})},g.walkTokens=function(h,n){let t=[];for(const e of h)switch(t=t.concat(n.call(g,e)),e.type){case"table":for(const s of e.header)t=t.concat(g.walkTokens(s.tokens,n));for(const s of e.rows)for(const a of s)t=t.concat(g.walkTokens(a.tokens,n));break;case"list":t=t.concat(g.walkTokens(e.items,n));break;default:g.defaults.extensions&&g.defaults.extensions.childTokens&&g.defaults.extensions.childTokens[e.type]?g.defaults.extensions.childTokens[e.type].forEach(function(s){t=t.concat(g.walkTokens(e[s],n))}):e.tokens&&(t=t.concat(g.walkTokens(e.tokens,n)))}return t},g.parseInline=X($.lexInline,E.parseInline),g.Parser=E,g.parser=E.parse,g.Renderer=U,g.TextRenderer=F,g.Lexer=$,g.lexer=$.lex,g.Tokenizer=D,g.Slugger=Y,g.Hooks=N,g.parse=g,g.options,g.setOptions,g.use,g.walkTokens,g.parseInline,E.parse,$.lex,()=>{let h,n,t=null;function e(){if(t&&!t.closed)t.focus();else{if(t=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),t.marked=g,t.document.write(`<!--
...
</html>`),!t)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const i=n.getConfig().url,o=typeof i=="string"?i:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;h=setInterval(function(){t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:n.getState(),url:o}),"*")},500),window.addEventListener("message",a)})()}}function s(i){let o=n.getCurrentSlide(),c=o.querySelectorAll("aside.notes"),d=o.querySelector(".current-fragment"),l={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:n.getState()};if(o.hasAttribute("data-notes")&&(l.notes=o.getAttribute("data-notes"),l.whitespace="pre-wrap"),d){let p=d.querySelector("aside.notes");p?(l.notes=p.innerHTML,l.markdown=typeof p.getAttribute("data-markdown")=="string",c=null):d.hasAttribute("data-notes")&&(l.notes=d.getAttribute("data-notes"),l.whitespace="pre-wrap",c=null)}c&&c.length&&(c=Array.from(c).filter(p=>p.closest(".fragment")===null),l.notes=c.map(p=>p.innerHTML).join(`
`),l.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(l),"*")}function a(i){if(function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}}(i))try{let o=JSON.parse(i.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(h),r()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&function(c,d,l){let p=n[c].apply(n,d);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:p,callId:l}),"*")}(o.methodName,o.arguments,o.callId)}catch{}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",o=>{if(!t&&typeof o.data=="string"){let d;try{d=JSON.parse(o.data)}catch{}d&&d.namespace==="reveal-notes"&&d.type==="heartbeat"&&(c=o.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}}})})(et);var kt=et.exports;const wt=mt(kt),yt=Object.freeze(Object.defineProperty({__proto__:null,default:wt},Symbol.toStringTag,{value:"Module"}));export{yt as n};
