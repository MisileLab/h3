...
export const getItemUnsafe = localStorage.getItem;
...
export const queryUnsafe = document.querySelector;
export const queryIdUnsafe = document.getElementById;

export function query(selector: string): HTMLElement { return nullVerify(queryUnsafe(selector)) }
export function queryId(id: string): HTMLElement { return nullVerify(queryIdUnsafe(id)) }
